...
export const dataObject = [
  ...
  { label: 'Asian Pear', value: 'Asian Pear' },
  { label: 'Asparagus', value: 'Asparagus' },
  { label: 'Atemoya', value: 'Atemoya' },
  { label: 'Avocado', value: 'Avocado' },
  { label: 'Bamboo Shoots', value: 'Bamboo Shoots' },
  { label: 'Banana', value: 'Banana' },
  { label: 'Bean Sprouts', value: 'Bean Sprouts' },
  { label: 'Beans', value: 'Beans' },
  { label: 'Beets', value: 'Beets' },
  { label: 'Belgian Endive', value: 'Belgian Endive' },
  ...
  { label: 'Dried Plums', value: 'Dried Plums' },
  ...
  { label: 'Horned Melon', value: 'Horned Melon' },
  ...
  { label: 'Lima Beans', value: 'Lima Beans' },
  { label: 'Limes', value: 'Limes' },
  { label: 'Longan', value: 'Longan' },
  { label: 'Loquat', value: 'Loquat' },
  { label: 'Lychee', value: 'Lychee' },
  { label: 'Madarins', value: 'Madarins' },
  { label: 'Malanga', value: 'Malanga' },
  { label: 'Mandarin Oranges', value: 'Mandarin Oranges' },
  ...
  { label: 'Persimmons', value: 'Persimmons' },
  ...
  { label: 'Red Cabbage', value: 'Red Cabbage' },
  ...
  { label: 'Tangerines', value: 'Tangerines' },
  { label: 'Tomatillo', value: 'Tomatillo' },
  { label: 'Tomato', value: 'Tomato' },
  { label: 'Turnip', value: 'Turnip' },
  { label: 'Ugli Fruit', value: 'Ugli Fruit' },
  { label: 'Water Chestnuts', value: 'Water Chestnuts' },
  { label: 'Watercress', value: 'Watercress' },
  { label: 'Watermelon', value: 'Watermelon' },
  { label: 'Waxed Beans', value: 'Waxed Beans' },
  { label: 'Yams', value: 'Yams' },
  { label: 'Yellow Squash', value: 'Yellow Squash' },
  { label: 'Yuca/Cassava', value: 'Yuca/Cassava' },
  { label: 'Zucchini Squash', value: 'Zucchini Squash' },
];
